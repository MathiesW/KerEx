...
from .base_models import BaseUnet, BaseSmoothUnet, BaseFourierUnet
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="FourierUnet1D")
class FourierUnet1D(BaseFourierUnet):
    """
    1-D implementation of Unet, cf. [Ronneberger et al.](https://arxiv.org/abs/1505.04597)
    ...
    Upsampling is realized using zero-padding in Fourier space.
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="FourierUnet2D")
class FourierUnet2D(BaseFourierUnet):
    """
    2-D implementation of Unet, cf. [Ronneberger et al.](https://arxiv.org/abs/1505.04597)
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="FourierUnet3D")
class FourierUnet3D(BaseFourierUnet):
    """
    3-D implementation of Unet, cf. [Ronneberger et al.](https://arxiv.org/abs/1505.04597)
