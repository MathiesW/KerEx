...
from .base_models import BaseFCN, BaseSmoothFCN, BaseFourierFCN
...
# MODELS THAT USE SMOOTH UPSAMPLING VIA IMAGE UPSAMPLING FOLLOWED BY A CONVOLUTION
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="SmoothFCN1D")
class SmoothFCN1D(BaseSmoothFCN):
    """
    1D implementation of FullyConvolutionalNetwork (FCN)
    ...
    Upsampling is performed using a stack of image upsampling and convolution
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="SmoothFCN2D")
class SmoothFCN2D(BaseSmoothFCN):
    """
    2D implementation of FullyConvolutionalNetwork (FCN)
    ...
    merge_layer : str | keras.layers.Layer, optional {`"concatenate"`, `"average"`, `"maximum"`, `"minimum"`, `"add"`, `"subtract"`, `"multiply"`, `"dot"`}
        ...
        For this parameter to have an impact, there has to be at least one skip connection in the model.
        Defaults to `"concatenate"`.
    interpolation : {`"bicubic"`, `"bilinear"`, `"lanczos3"`, `"lanczos5"`, `"nearest"`}, optional
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="SmoothFCN3D")
class SmoothFCN3D(BaseSmoothFCN):
    """
    3D implementation of FullyConvolutionalNetwork (FCN)
...
# MODELS THAT USE UPSAMPLING IN FOURIER SPACE
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="FourierFCN1D")
class FourierFCN1D(BaseFourierFCN):
    """
    1D implementation of FullyConvolutionalNetwork (FCN)
    ...
    Upsampling is performed via zero-padding in Fourier space
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="FourierFCN2D")
class FourierFCN2D(BaseFourierFCN):
    """
    2D implementation of FullyConvolutionalNetwork (FCN)
...
@saving.register_keras_serializable(package="Kerex.Models.AutoEncoder", name="FourierFCN3D")
class FourierFCN3D(BaseFourierFCN):
    """
    3D implementation of FullyConvolutionalNetwork (FCN)
