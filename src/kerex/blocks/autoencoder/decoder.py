from .base_decoder import BaseDecoder, BaseSmoothDecoder, BaseFourierDecoder
    ...
    **kwargs : Additional keyword arguments for the `keras.layers.Layer` super-class.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            dilation_rate=dilation_rate, 
            groups=groups, 
            upsamling_filters=upsamling_filters,
            activation=activation, 
            merge_layer=merge_layer,
            use_bias=use_bias, 
            kernel_initializer=kernel_initializer, 
    ...
    **kwargs : Additional keyword arguments for the `keras.layers.Layer` super-class.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            dilation_rate=dilation_rate, 
            groups=groups, 
            upsampling_filters=upsamling_filters,
            activation=activation, 
            merge_layer=merge_layer, 
            use_bias=use_bias, 
            kernel_initializer=kernel_initializer, 
